...
const Contact = ({failMessage = "Error sending email. Try again later.", successMessage = "Thank you. Your email sent successfully."}) => {
  const form = useRef();
      ...
      .then(
        (result) => {
          toast.dark(successMessage, {
            type: "success",
            autoClose: true,
            progressStyle: { backgroundColor: "#f52225" },
            style: { border: "solid 1px #f52225" },
          });
          e.target.reset();
          console.log(result.text);
        },
        (error) => {
          toast.dark(failMessage, {
            type: "error",
            autoClose: true,
            progressStyle: { backgroundColor: "#f52225" },
            style: { border: "solid 1px #f52225" },
